...
export default function StatusBar() {
    ...
    return (
        <div className='absolute right-8 top-4'>
            ...
            <div className="p-2 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md flex flex-col">
                <div className='flex flex-row justify-center content-center items-center ml-1 '>
                    ...
                    <div className="grid grid-cols-3 my-2 justify-center items-center content-center text-center divide-x">
                        ...
                        <Link end to="/notifications" className="p-2 bg-white w-fit h-fit hover:bg-gray-200 rounded-lg shadow-md ml-1">
                        ...
                        <Link end to="/settings" className="p-2 bg-white w-fit h-fit hover:bg-gray-200 rounded-lg shadow-md ml-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#444444" className="w-6 h-6">
